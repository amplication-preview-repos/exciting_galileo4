...
@InputType()
class AccommodationCreateNestedManyWithoutHostsInput {
...
export { AccommodationCreateNestedManyWithoutHostsInput as AccommodationCreateNestedManyWithoutHostsInput };
