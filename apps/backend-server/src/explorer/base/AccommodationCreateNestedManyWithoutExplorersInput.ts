...
@InputType()
class AccommodationCreateNestedManyWithoutExplorersInput {
...
export { AccommodationCreateNestedManyWithoutExplorersInput as AccommodationCreateNestedManyWithoutExplorersInput };
